...
const Timeout = () => {
  ...
  return (
    <div
      ...
      className="overflow-hidden w-full flex flex-col items-center justify-center h-screen bg-no-repeat bg-center bg-cover"
    >
          ...
          <div className="mt-10 flex flex-col gap-7 text-white">
            <div className="flex items-center gap-">
              <div className="flex gap-4 text-[#D0D0D0] text-[10px] items-center">
                ...
                <Link to="/">
                  <button className="hover:border-b-[1px] border-[#DFD46F] items-center duration-100">
                    Time in{" "}
                  </button>
                </Link>
                <p>|</p>
              ...
              <table className="bg-white rounded-md shadow-lg min-w-[500px] max-h-[500px] h-[400px] absolute">
                ...
                <tbody className="">
                  {attendance.map((student, index) => {
                    return (
                      <tr key={index}>
                        <td className="text-black text-[11px] text-center items-center border-r-2 border-b-2">
                          {student.name}
                        </td>
                        <td className="text-black text-[11px] text-center items-center border-r-2 border-b-2">
                          {student.course}
