        ...
        <div className="bg-white max-h-[500px] overflow-x-hidden overflow-scroll rounded-lg px-3 pb-4">
          <div className="flex justify-between gap-4 py-4 px-2 items-center">
            ...
            <input
              ...
              className="border-b-2 focus:outline-0"
            />
              ...
              {student
                .filter((each) => {
                  if (search === "") {
                    ...
                    each.department.toLowerCase().includes(search.toLowerCase())
                  ) {
                    return each;
                  } else if (
                    each.year.toLowerCase().includes(search.toLowerCase())
                  ) {
                    return each;
                  }
                })
