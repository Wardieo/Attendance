            ...
            return (
              <div className="flex flex-col gap-5 pt-10">
                <ul key={index} className="text-xl flex flex-col gap-6">
                  <li>
                    Name: <span className="font-bold px-3">{each.name}</span>
                  </li>
                  <li>
                    USN:{" "}
                    <span className="font-bold px-3">
                      {each.student_info_id}
                    </span>
                  </li>
                  <li>
                    Course:{" "}
                    <span className="font-bold px-3">{each.course}</span>
                  </li>
                  <li>
                    Year: <span className="font-bold px-3">{each.year}</span>
                  </li>
                  <li>
                    Department:{" "}
                    <span className="font-bold px-3">{each.department}</span>
                  </li>
                </ul>
              </div>
            );
